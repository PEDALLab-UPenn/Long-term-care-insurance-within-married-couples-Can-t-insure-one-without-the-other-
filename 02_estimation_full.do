...
*               Output table: Main Table 3 ME and Appendix Table 5        *
...
capture program drop conditions
	...
	loc table5 "$output/LTCI_M_Table5.rtf"
...
havestepkids_m havestepkids_f man_has_sons woman_has_daughters 
	...
	esttab table1 table2 table3 table4 using `table5', se `format3' ti("Table 5. LTCI Purchase") label replace 

    sa "$createddata/LTCI_couple_sumstats.dta", replace
