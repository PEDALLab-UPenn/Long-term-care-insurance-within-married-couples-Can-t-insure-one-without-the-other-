...
*               Output table: Main Table 3 ME and Appendix Table 6        *
...
capture program drop conditions
	...
	loc table6    "$output/LTCI_M_Table6.rtf"
    loc table6mfx "$output/LTCI_M_Table6_MFX.rtf"
...
* Mutlinomial logit - 4 outcomes
    ...
    * Suppress 4 lines of code based on HRS disclosure rules
...
havestepkids_m havestepkids_f man_has_sons woman_has_daughters 
		...
		mlogit outcome i.ptr_finlsy_hlthins_max_f `vars' i.wave i.stateid_f i.ind2013 i.ind2013##i.ptr_finlsy_hlthins_max_f, base(0) vce(cluster couple) 		
	...
	esttab table1 table2 table3 table4 using `table6', se `format3' ti("Table 6. LTCI Purchase- Interaction") label replace 



	
* Get the MFX of interaction terms
...
havestepkids_m havestepkids_f man_has_sons woman_has_daughters 
		...
		mlogit outcome `vars' i.wave i.stateid_f i.ind2013 i.ptr_finlsy_hlthins_max_f i.ind2013##i.ptr_finlsy_hlthins_max_f, base(0) vce(cluster couple)
		margins i.ptr_finlsy_hlthins_max_f, dydx(i.ind2013) predict(outcome(1)) post
			est sto table2
		mlogit outcome `vars' i.wave i.stateid_f i.ind2013 i.ptr_finlsy_hlthins_max_f i.ind2013##i.ptr_finlsy_hlthins_max_f, base(0) vce(cluster couple)
		margins i.ptr_finlsy_hlthins_max_f, dydx(i.ind2013) predict(outcome(2)) post
			est sto table3		
		mlogit outcome `vars' i.wave i.stateid_f i.ind2013 i.ptr_finlsy_hlthins_max_f i.ind2013##i.ptr_finlsy_hlthins_max_f, base(0) vce(cluster couple)
		margins i.ptr_finlsy_hlthins_max_f, dydx(i.ind2013) predict(outcome(3)) post
			est sto table4

	esttab table2 table3 table4 using `table6mfx', se `format3' ti("Table 6. LTCI Purchase- Interaction MFX") label replace 